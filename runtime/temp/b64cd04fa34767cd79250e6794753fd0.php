            ...
            <div class="card">
                <div class="card-header">
                    ...
                    <div class="card-header-form ml-auto">
                        <a href="<?php echo url('series/detail'); ?>" class="btn btn-icon icon-left btn-primary"><i class="far fa-edit"></i> 创建</a>
                    </div>
                </div>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <div class="chocolat-parent">
                                        <a class="chocolat-image" href="/uploads/<?php echo htmlentities($vo['cover']); ?>" title="<?php echo htmlentities($vo['name']); ?>">
                                            <img width="100" src="/uploads/<?php echo htmlentities($vo['cover']); ?>" />
                                        </a>
                                    </div>
                                    <?php endif; ?>
                                </td>
                                <td>
                                    <a href="<?php echo url('series/detail', ['id' => $vo['id']]); ?>" class="btn btn-icon icon-left btn-primary mr-3"><i class="far fa-edit"></i> 编辑</a>
                                    ...
                                    <input id="upload_image" type="file" name="file" value="" multiple accept="image/*" onchange="uploadImg(this, <?php echo htmlentities($vo['id']); ?>);" style="display: none">
...
function delImage(id) {
    ...
    .then((willDelete) => {
        ...
        $.ajax({
            url: "<?php echo url('series/destroy'); ?>",
            method: 'post',
            data: {id: id},
            dataType: 'json',
            success(res) {
...
function uploadImg(obj, id) {
    ...
    $.ajax({
        url: "<?php echo url('series/upload_product'); ?>",
        method: 'post',
        data: formData,
        dataType: 'json',
        cache: false,
