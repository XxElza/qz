...
<div class="section-header">
    <div class="section-header-breadcrumb">
        ...
        <div class="breadcrumb-item">新闻资讯管理</div>
    </div>
</div>

<div class="section-body">
    <h2 class="section-title">新闻资讯管理</h2>
            ...
            <div class="card">
                <div class="card-header">
                    <div class="card-header-form ml-auto">
                        <a href="<?php echo url('News/detail'); ?>" class="btn btn-icon icon-left btn-primary"><i class="far fa-edit"></i> 创建</a>
                    </div>
                </div>
                    ...
                    <div class="table-responsive">
                        <table class="table table-bordered table-md">
                            ...
                            <tr>
                                ...
                                <td><?php echo date('Y-m-d', strtotime($vo['send_time'])); ?></td>
                                <td>
                                    <a href="<?php echo url('News/detail', ['id' => $vo['id']]); ?>" class="btn btn-icon icon-left btn-primary mr-3"><i class="far fa-edit"></i> 编辑</a>
