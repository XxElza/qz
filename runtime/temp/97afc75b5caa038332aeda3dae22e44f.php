            ...
            <div class="card">
                <div class="card-header">
                    ...
                    <div class="card-header-form ml-auto">
                        <a href="<?php echo url('Brand/detail'); ?>" class="btn btn-icon icon-left btn-primary"><i class="far fa-edit"></i> 创建</a>
                    </div>
                </div>
                    ...
                    <div class="table-responsive">
                        <table class="table table-bordered table-md">
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="<?php echo url('Brand/detail', ['id' => $vo['id']]); ?>" class="btn btn-icon icon-left btn-primary mr-3"><i class="far fa-edit"></i> 编辑</a>
...
function delImage(id) {
    ...
    .then((willDelete) => {
        ...
        $.ajax({
            url: "<?php echo url('Brand/destroy'); ?>",
            method: 'post',
            data: {id: id},
            dataType: 'json',
            success(res) {
