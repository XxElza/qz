...
<div class="section-header">
    <div class="section-header-breadcrumb">
        ...
        <div class="breadcrumb-item"><a href="<?php echo url('Images/index'); ?>">品牌管理</a></div>
        <div class="breadcrumb-item"><?php echo htmlentities($title); ?></div>
    </div>
</div>

<div class="section-body">
    <h2 class="section-title">网站图片管理 - <?php echo htmlentities($title); ?></h2>
    ...
    $.ajax({
        ...
        success(res) {
            ...
            if (res.success === true) {
                ...
                setTimeout(function () { window.location = "<?php echo url('Brand/index'); ?>" }, 1500)
            }
            if (res.success === false) swal('出现错误', res.err_msg, 'error');
        }
    })
