...
<div class="section-header">
    <div class="section-header-breadcrumb">
        ...
        <div class="breadcrumb-item"><a href="<?php echo url('News/index'); ?>">新闻资讯管理</a></div>
        <div class="breadcrumb-item"><?php echo htmlentities($title); ?></div>
    </div>
</div>

<div class="section-body">
    <h2 class="section-title">新闻资讯管理 - <?php echo htmlentities($title); ?></h2>
                    ...
                    <div class="card-body">
                        <div class="form-group row mb-4">
                            ...
                            <div class="col-sm-12 col-md-7">
                                <input type="text" class="form-control" name="title" required="" value="<?php echo htmlentities($data['title']); ?>">
                        ...
                        <div class="form-group row mb-4">
                            ...
                            <div class="col-sm-12 col-md-7">
                                <input type="text" class="form-control" name="en_title" required="" value="<?php echo htmlentities($data['en_title']); ?>">
                            </div>
                        </div>
                        ...
                        <div class="form-group row mb-4">
                            ...
                            <div class="col-sm-12 col-md-7">
                                <textarea class="summernote-simple" name="content"><?php echo htmlentities($data['content']); ?></textarea>
                            </div>
                        </div>
                        ...
                        <div class="form-group row mb-4">
                            ...
                            <div class="col-sm-12 col-md-7">
                                <textarea class="summernote-simple" name="en_content"><?php echo htmlentities($data['en_content']); ?></textarea>
                            </div>
                        </div>
                        ...
                        <div class="form-group row mb-4">
                            ...
                            <div class="col-sm-12 col-md-7">
                                <input type="text" class="form-control datepicker" name="send_time" value="<?php echo htmlentities($data['send_time']); ?>">
                            </div>
                        </div>
    ...
    $.ajax({
        ...
        success(res) {
            ...
            if (res.success === true) {
                ...
                setTimeout(function () { window.location = "<?php echo url('News/index'); ?>" }, 1500)
            }
            if (res.success === false) swal('出现错误', res.err_msg, 'error');
        }
    })
